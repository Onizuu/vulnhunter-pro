...
%\AddToShipoutPicture*{\EtiquetteThese}
  ...
  \centering
    ...
    \vspace{1cm}
    	{\huge\color[rgb]{0,60,120} \bfseries{\@title}}\\
    \vspace{0.5cm}
...
\centering
\textbf{Lien GitHub du projet :}\\[0.3em]
\href{https://github.com/Onizuu/vulnhunter-pro}
{\texttt{https://github.com/Onizuu/vulnhunter-pro}}
\end{tcolorbox}
\end{center}
